...
import static cn.baker.gateway.config.HttpClientProperties.Pool.PoolType.DISABLED;
import static cn.baker.gateway.config.HttpClientProperties.Pool.PoolType.FIXED;
